...
//===================================================全局变量BEG===================================================
extern int    Control_Flag;                                    // 遥控器控制标志位，每按下一次翻转一次，当它为1时是遥控模式，为0时是循迹模式，默认循迹（为0）
extern int    RemoteCtrl_Start_Stop_Flag;                      // 遥控器启停标志位，每按下一次翻转一次，当它为1时是启动状态，为0时是停止状态，默认停止（为0）
